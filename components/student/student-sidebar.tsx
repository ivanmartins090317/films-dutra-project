...
export function StudentSidebar() {
  ...
  return (
    <aside className="flex w-full flex-col gap-1 border-border bg-card/80 px-3 py-4 backdrop-blur-sm md:h-full md:min-h-full md:w-full md:shrink-0 md:border-r">
